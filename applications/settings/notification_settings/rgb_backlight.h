...
#define RGB_BACKLIGHT_INTERNAL_MODE_AUTO 0
#define RGB_BACKLIGHT_INTERNAL_MODE_ON 1
...
typedef struct {
    ...
    uint8_t internal_color_index;
    uint8_t internal_brightness;
    uint8_t internal_mode;
    uint8_t custom_colors[LED_COUNT][3];
